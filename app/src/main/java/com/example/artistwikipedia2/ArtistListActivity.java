...
public class ArtistListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Feel free to read other artists' information", Snackbar.LENGTH_LONG)
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final ArtistListActivity mParentActivity;
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(ArtistDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(ArtistDetailFragment.ARG_ITEM_ID, item.id);
        ...
        SimpleItemRecyclerViewAdapter(ArtistListActivity parent,
